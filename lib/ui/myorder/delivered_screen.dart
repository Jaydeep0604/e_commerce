...
class DeliveredScreen extends StatefulWidget {
  static const deliveredScreen="/deliveredScreen";
...
class _DeliveredScreenState extends State<DeliveredScreen> {
  List<OrderModel> item = [
    ...
    OrderModel(
        "1", "№1947034", "05-12-2019", "IW3475453455", "3", "125", "Delivered"),
    OrderModel(
        "1", "№1947035", "07-12-2019", "IW3475453455", "3", "124", "Delivered"),
    OrderModel(
        "1", "№1947035", "07-12-2019", "IW3475453455", "3", "124", "Delivered"),
    OrderModel(
        "1", "№1947035", "07-12-2019", "IW3475453455", "3", "124", "Delivered"),
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            return GestureDetector(
                ...
                child: OrderDeliveredWidget(orderModel: item[index]));
          },
